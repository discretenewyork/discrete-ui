  ...
  <div>
    <Container style={{ margin: '64px auto' }}>
      ...
      <Section
        ...
        <p>
          <label htmlFor='light' style={labelStyle}>Light:</label>
        ...
        <p>
          <label htmlFor='regular' style={labelStyle}>Regular:</label>
        ...
        <p>
          <label htmlFor='bold' style={labelStyle}>Bold:</label>
        ...
        <p>
          <label htmlFor='solid' style={labelStyle}>Solid:</label>
